/**
 * Pitch.com Automation - Create Combined Presentation with All 3 Slides
 *
 * Creates ONE presentation containing all 3 slides sequentially:
 * - Slide 1: Case Studies
 * - Slide 2: PnL
 * - Slide 3: Angles
 *
 * Features:
...
const CONFIG = {
  ...
  slides: [
    { name: 'Case Studies', dataFile: 'slides/case_studies.txt' },
    { name: 'PnL', dataFile: 'slides/pnl.txt' },
    { name: 'Angles', dataFile: 'slides/angles.txt' }
  ]
};
  ...
  try {
    ...
    for (let i = 0; i < CONFIG.slides.length; i++) {
      ...
      if (i < CONFIG.slides.length - 1) {
        ...
        await page.waitForTimeout(3000); // Wait for template picker
